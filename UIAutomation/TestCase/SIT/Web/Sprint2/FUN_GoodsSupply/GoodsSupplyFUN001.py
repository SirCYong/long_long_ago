...
from common.page.browser.LoginPage import LoginPage
from common.page.browser.PublishGoodsSupply.GoodsSupplyPage import GoodsSupplyPage
from testcase.SIT.Web.Sprint2.FUN_GoodsSupply import RestoreSQL


class GoodsSupply(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sleep(1)
        LoginPage(self.driver).login('199265', '1')
        pass
