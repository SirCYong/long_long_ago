...
from .FunFindWarehouseSupplyDemandSmokeSQL import reduction_warehouse_supply_contract, get_warehouse_sign_result

__author__ = "zhongchangwei"
__package__ = 'IscsUIAutomation'


class FunFindWarehouseSupplySmokeTest(BaseTestCase):
    """
