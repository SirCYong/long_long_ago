...
class SelectXpressMainPage(BasePage):
    def __init__(self, driver):
        ...
        self.driver = driver
        self.buyers_request_add_button_locator = None
        self.buyers_refused_add_button_locator = None
        self.buyers_request_text_locator = None
        self.buyers_refused_text_locator = None
        self.order_number_locator = None
        self.receipt_address_locator = None
    ...
    def page_factory(self):
        ...
        self.return_locator = ele_dic['return']  # 返回
